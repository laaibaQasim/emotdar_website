...
recording_directory = os.path.join(os.path.dirname(os.path.abspath(__file__)), "../static/recordings")

# Define the directory where the default emoji GIF is stored
emoji_directory = os.path.join(os.path.dirname(os.path.abspath(__file__)), "../static/emojis")
